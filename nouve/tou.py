...
class Blackjackinterface:
    def __init__(self):
        ...
        self.start_duo = tk.Button(self.window, text="mode duo", bg='gray', fg='black',activebackground="black",activeforeground='gray',relief=tk.FLAT,)
...
#        return cagnotte
    ...
    def create_widgets(self):
        ...
        self.player_cagnotte_label = ttk.Label(self.player_frame, text="")
